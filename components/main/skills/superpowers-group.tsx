...
export default function SuperPowersGroup({id, className}: contentProps){
    const cardClassName = "group relative overflow-hidden border-0 shadow-none ring-1 ring-neutral-200 bg-gradient-to-br from-blue-50 via-neutral-50 to-neutral-100 transition-all duration-300 ease-out hover:-translate-y-1 hover:ring-neutral-300"
    return (
